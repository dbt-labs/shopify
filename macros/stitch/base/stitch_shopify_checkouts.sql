...
{% macro default__stitch_shopify_checkouts() %}
    ...
    select
        ...
        nullif(billing_address__address1, '') as billing_address_address1,
        nullif(billing_address__address2, '') as billing_address_address2,
        nullif(billing_address__city, '') as billing_city,
        nullif(billing_address__company, '') as billing_company,
        nullif(billing_address__country, '') as billing_country,
        nullif(billing_address__country_code, '') as billing_country_code,
        nullif(billing_address__first_name, '') as billing_first_name,
        nullif(billing_address__last_name, '') as billing_last_name,
        nullif(billing_address__latitude, '') as billing_latitude,
        nullif(billing_address__longitude, '') as billing_longitude,
        nullif(billing_address__name, '') as billing_name,
        nullif(billing_address__phone, '') as billing_phone,
        nullif(billing_address__province, '') as billing_province,
        nullif(billing_address__province_code, '') 
            as billing_province_code,
        nullif(billing_address__zip, '') as billing_zip,
            
        nullif(shipping_address__address1, '') 
            as shipping_address_address1,
        nullif(shipping_address__address2, '') 
            as shipping_address_address2,
        nullif(shipping_address__city, '') as shipping_city,
        nullif(shipping_address__company, '') as shipping_company,
        nullif(shipping_address__country, '') as shipping_country,
        nullif(shipping_address__country_code, '') 
            as shipping_country_code,
        nullif(shipping_address__first_name, '') as shipping_first_name,
        nullif(shipping_address__last_name, '') as shipping_last_name,
        nullif(shipping_address__longitude, '') as shipping_longitude,
        nullif(shipping_address__latitude, '') as shipping_latitude,
        nullif(shipping_address__name, '') as shipping_name,
        nullif(shipping_address__phone, '') as shipping_phone,
        nullif(shipping_address__province, '') as shipping_province,
        nullif(shipping_address__province_code, '') 
            as shipping_province_code,
        nullif(shipping_address__zip, '') as shipping_zip,
